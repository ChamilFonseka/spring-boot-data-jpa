...
public class Owner extends BaseEntity {
    ...
    public static Owner of(OwnerDto ownerDto) {
        return Owner.builder()
                ...
                .address(new Address(ownerDto.street(), ownerDto.city(), ownerDto.state(), ownerDto.zipCode()))
                .build();
    }
    ...
    public void update(OwnerDto ownerDto) {
        ...
        this.address = new Address(ownerDto.street(), ownerDto.city(), ownerDto.state(), ownerDto.zipCode());
    }
